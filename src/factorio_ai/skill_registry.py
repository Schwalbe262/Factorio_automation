...
IMPLEMENTED_SKILLS = {
    ...
    "setup_stone_supply": "StoneSupplySkill",
    "connect_coal_fuel_feed": "CoalFuelFeedSkill",
    ...
    "research_electric_mining_drill": "ResearchTechnologySkill",
    "bootstrap_build_item_mall": "BuildItemMallSkill",
    "bootstrap_power_pole_mall": "BuildItemMallSkill",
    "bootstrap_electric_mining_drill_mall": "BuildItemMallSkill",
