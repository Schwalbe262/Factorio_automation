...
def summarize_factory(
    ...
    return {
        ...
        # Full enriched recipe map for the web reference: every item -> {in, out, cat, fluid}.
        "dependency_map": recipe_details(flat_dependency_map().keys()),
        "crafting_facilities": facility_legend(),
